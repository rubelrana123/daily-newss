          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <div class="card-text d-flex justify-content-between">
                  ...
                  <p class = "mt-3">${
										news.author.name ? news.author.name : 'unknow'
									}</p>
                  ...
                  <div class= "mt-3">
                   ...
                   <span> View ${
											news.total_view ? news.total_view + 'M' : 'Empty'
										}</span>
                </p>
                  </div>
                  <button onclick ="loadModalDetails('${
										news._id
									}')" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newsDetailsModal" style ="height: 40px">See More</button>
